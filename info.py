...
BOT_TOKEN = environ.get('BOT_TOKEN', "5390357278:AAG0UaSs2IEAcRZIW-2aeBhXQIhlKe8O97c")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2078209880').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001658287786').split()]
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001658287786))
